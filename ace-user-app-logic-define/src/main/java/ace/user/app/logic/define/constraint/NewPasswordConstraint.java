 ...
 * @description
 */
@NotBlank(message = "请输入" + NewPasswordConstraint.FIELD_NAME)
@Pattern(regexp = PatternConstants.PASSWORD, message = "请输入正确的" + NewPasswordConstraint.FIELD_NAME +
